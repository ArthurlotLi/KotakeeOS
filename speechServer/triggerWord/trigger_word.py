...
#
# Usage: python3 server_reference_code.py 1 <- Uses iteration number 1 in the triggerWordDetection/models directory.
#
...
def runApplicationServer(iternum):
  ...
  if(model is None):
    print('[ERROR] Unable to load trigger word detection model. Path: ../../triggerWordDetection/models/tr_model_'+str(iternum) +'.h5. Stopping...')
    return
